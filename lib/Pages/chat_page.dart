...
class ChatPageState extends State<ChatPage> {
  ...
  //late ConvoProvider convoProvider;
  ...
  void initState() {
    ...
    //convoProvider = context.read<ConvoProvider>();
  ...
  void onSendMessages(String content, int type) {
    if (content.trim().isNotEmpty) {
      payTextEditingController.clear();
      chatProvider.sendMessages(
          content, type, groupChatId, currentUserId, peerId, context);
          ...
          Flexible(
            child: Container(
              child: TextField(
                onSubmitted: (value) {
                  onSendMessages(
                      payTextEditingController.text, TypeMessage.text);
                },
                style:
                ...
                decoration: InputDecoration.collapsed(
                  hintText: '.....Amount...',
                  hintStyle: TextStyle(
                    color: Color.fromARGB(255, 126, 217, 86),
                  ),
                ),
                focusNode: focusNode,
              ),

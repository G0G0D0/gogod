...
import '../providers/authfree_provider.dart';
...
class ConvoPage extends StatefulWidget {
  ...
  ConvoPage({Key? key, required this.peerId, required this.peerAvatar, required this.peerNickname}) : super(key: key);

  @override
  State createState() => ConvoPageState(
    peerId: this.peerId,
...
class ConvoPageState extends State<ConvoPage> {
  ConvoPageState({Key? key, required this.peerId, required this.peerAvatar, required this.peerNickname});
  ...
  late AuthFreeProvider authFreeProvider;

  @override
  void initState() {
    super.initState();
    chatProvider = context.read<ChatProvider>();
    authFreeProvider = context.read<AuthFreeProvider>();
  ...
  void readLocal() {
    if (authFreeProvider.getUserFirebaseId()?.isNotEmpty == true) {
      currentUserId = authFreeProvider.getUserFirebaseId()!;
    } else {
    ...
    chatProvider.updateDataFirestore(
      FirestoreConstants.pathFreelancerCollection,
      currentUserId,

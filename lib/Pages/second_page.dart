...
import 'package:Gogodo/Pages/freelancer_chat.dart';
...
class SecondPageState extends State<SecondPage> {
  ...
  void initState() {
    ...
    secondProvider = context.read<SecondProvider>();
  ...
  void registerNotification() {
    ...
    firebaseMessaging.getToken().then((token) {
      ...
      if (token != null) {
        secondProvider.updateDataFirestore(FirestoreConstants.pathFreelancerCollection, currentUserId, {'pushToken': token});
      }
    }).catchError((err) {
  ...
  void onItemMenuPress(PopupChoices choice) {
    if (choice.title == 'Log out') {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => FreelancerChat()));
            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  stream: secondProvider.getStreamFireStore(FirestoreConstants.pathUserCollection, _limit, _textSearch),
                  ...
                  child: Container(
                    child: Column(
                      children: <Widget>[
                        ...
                        Container(
                          child: Text(
                            'Searching for: ${userChat.aboutMe}',
                            maxLines: 1,
                            style: TextStyle(color: ColorConstants.primaryColor),
                          ),
                          alignment: Alignment.centerLeft,

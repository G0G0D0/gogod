...
class MessageChat {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      FirestoreConstants.groupchatID: this.chatId,
  ...
  factory MessageChat.fromDocument(DocumentSnapshot doc) {
    ...
    String chatId = doc.get(FirestoreConstants.groupchatID);
    return MessageChat(idFrom: idFrom, idTo: idTo, timestamp: timestamp, content: content, type: type, chatId: chatId);
  }
}